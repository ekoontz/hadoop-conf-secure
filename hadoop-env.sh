...
export HADOOP_JOURNALNODE_OPTS="-Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=5010"
export HADOOP_SECURE_DN_USER=`whoami`

# 5007 is for YARN Resourcemanager.
# 5008 is for YARN Nodemanager.
